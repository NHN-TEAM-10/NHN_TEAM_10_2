...
public class Expr {
     ...
     */
    public Expr(String definition) throws IllegalArgumentException{
        parse(definition);
    }
    ...
    private void error(String message) throws IllegalArgumentException {  // called when an error occurs during parsing
