...
public class Exercise6 {
    ...
    private static ArrayList<AdditionQuestion> additionQuestion = new ArrayList<>();
    ...
    private static void grading() {
        ...
        for (int i = 0; i < QUIZ_SIZE; i++) {
            int quizAnswer = additionQuestion.get(i).getCorrectAnswer() ;
        ...
        for (int i = 0; i < QUIZ_SIZE; i++) {
            int quizAnswer = additionQuestion.get(i).getCorrectAnswer() ;
            System.out.println(additionQuestion.get(i).getQuestion() + quizAnswer);
        }
    ...
    private static void manageQuiz() {
        ...
        for (int i = 0; i < QUIZ_SIZE; i++) {
            System.out.println(additionQuestion.get(i).getQuestion());
